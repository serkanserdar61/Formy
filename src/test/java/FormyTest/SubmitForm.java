...
//    String jobTitle = "Computer Engineer";
    ...
    public void SubmitFormFormWebsite(String firstName, String lastName, String jobTitle) throws InterruptedException {
        ...
        Assert.assertEquals(firsNameTitleText, "First name");

        WebElement lastNameText = driver.findElement(By.cssSelector("#job-title"));
        String lastNameTitleText = firstNameText.getText();
...
//       sendkey to first name input box
        ...
        Assert.assertEquals(textMessage,"The form was successfully submitted!");
